...
<head>
    ...
    <meta name="description" content="{{ $metaDescription ?? 'Sign in or register for Bontrouver marketplace.' }}">
...
<body class="auth-pure-body">

    <!-- Pure Auth Content Area -->
    <main class="auth-pure-main">
        @yield('content')
    </main>
