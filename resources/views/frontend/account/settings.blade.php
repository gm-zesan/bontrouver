...
@section('account_content')
    ...
    @if (session('status'))
        <div class="alert alert-success alert-custom mb-4 p-3 rounded-3"
            style="background: rgba(73, 209, 125, 0.1); border: 1px solid rgba(73, 209, 125, 0.3); color: #49D17D;">
    ...
    <div class="d-flex flex-column gap-4">
            ...
            <form method="POST" action="{{ route('settings.update') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="email" class="form-control dark-filter-input" value="{{ Auth::user()->email }}"
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="tel" name="phone" class="form-control dark-filter-input"
                            value="{{ Auth::user()->phone ?? '+1 (416) 555-0192' }}">
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="location" class="form-control dark-filter-input"
                            value="{{ Auth::user()->location ?? 'Montreal, QC' }}">
                    </div>

                    <div class="col-12">
                        <label class="form-label text-secondary small fw-semibold">Public Bio / Seller Info</label>
                        <textarea name="bio" rows="3"
                            class="form-control dark-filter-input">{{ Auth::user()->bio ?? 'Verified seller and active buyer based in Montreal and Toronto.' }}</textarea>
                    </div>
            ...
            <div class="d-flex flex-column gap-3">
                <div class="d-flex align-items-center justify-content-between p-3 rounded-3"
                    ...
                    <div>
                        ...
                        <p class="text-secondary small mb-0" style="font-size: 0.78rem;">Receive real-time push and email
                            alerts when a buyer sends a message.</p>
                    </div>
                ...
                <div class="d-flex align-items-center justify-content-between p-3 rounded-3"
                    ...
                    <div>
                        ...
                        <p class="text-secondary small mb-0" style="font-size: 0.78rem;">Get notified immediately when
                            sellers drop prices on ads you saved.</p>
                    </div>
                    <div class="form-check form-switch ms-3">
                        <input class="form-check-input" type="checkbox" role="switch" checked
                            style="width: 2.2em; height: 1.2em;">
                ...
                <div class="d-flex align-items-center justify-content-between p-3 rounded-3"
                    ...
                    <div>
                        ...
                        <p class="text-secondary small mb-0" style="font-size: 0.78rem;">Remind me 4 days before active
                            listings are due to expire.</p>
                    </div>
                    <div class="form-check form-switch ms-3">
                        <input class="form-check-input" type="checkbox" role="switch" checked
                            style="width: 2.2em; height: 1.2em;">
        ...
        <div class="dark-surface-card p-4 rounded-4"
            ...
            <p class="text-secondary small mb-3" style="font-size: 0.84rem; line-height: 1.5;">
                Once your account is deleted, all of your active ads, saved items, chat conversations, and ratings will be
                permanently removed.
            </p>
            ...
            <div class="modal-content"
                ...
                <form method="post" action="{{ route('profile.destroy') }}">
                    ...
                    <div class="modal-header border-0 pb-0 pt-4 px-4 text-center d-block">
                        ...
                        <h5 class="modal-title text-white fw-bold" id="deleteAccountModalLabel">Are you sure you want to
                            delete your account?</h5>
                    </div>

                    <div class="modal-body px-4 py-3 text-center">
                        <p class="text-secondary small mb-3">
                            Please enter your password to confirm you would like to permanently delete your Bontrouver
                            account and data.
                        </p>
