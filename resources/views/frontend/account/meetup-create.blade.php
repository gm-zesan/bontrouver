...
<div class="create-meetup-card shadow-lg">
    <form action="{{ route('community.store') }}" method="POST">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="e.g. Saturday Morning Hike at Mount Royal" required>
                    @error('title')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="datetime-local" name="meetup_date_time" class="form-control @error('meetup_date_time') is-invalid @enderror" value="{{ old('meetup_date_time') }}" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="5" placeholder="Describe the meetup, what to expect, and who should join..." required>{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="location_name" class="form-control @error('location_name') is-invalid @enderror" value="{{ old('location_name') }}" placeholder="e.g. Tim Hortons, High Park Entrance" required>
                    @error('location_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="headcount_limit" class="form-control @error('headcount_limit') is-invalid @enderror" value="{{ old('headcount_limit') }}" placeholder="Leave blank for unlimited" min="2" max="100">
                ...
                <div class="mb-4">
                    ...
                    <div class="card mb-2 expense-radio-card">
                        <div class="card-body py-2 px-3">
                            <div class="form-check d-flex align-items-center mb-0">
                                <input class="form-check-input flex-shrink-0 me-3" type="radio" name="expense_type" id="expenseFree" value="free" {{ old('expense_type', 'free') == 'free' ? 'checked' : '' }}>
                                <label class="form-check-label flex-grow-1 cursor-pointer w-100 m-0 py-1" for="expenseFree">
                                    <div class="fw-bold text-success-custom"><i class="bi bi-balloon me-1"></i> Free Activity</div>
                    ...
                    <div class="card mb-2 expense-radio-card">
                        <div class="card-body py-2 px-3">
                            <div class="form-check d-flex align-items-center mb-0">
                                <input class="form-check-input flex-shrink-0 me-3" type="radio" name="expense_type" id="expenseSplit" value="split" {{ old('expense_type') == 'split' ? 'checked' : '' }}>
                                <label class="form-check-label flex-grow-1 cursor-pointer w-100 m-0 py-1" for="expenseSplit">
                                    <div class="fw-bold text-primary-custom"><i class="bi bi-pie-chart me-1"></i> Split the Bill</div>
                                    <div class="small text-white-50">Everyone pays for themselves (e.g. coffee shop)</div>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card expense-radio-card">
                        <div class="card-body py-2 px-3">
                            <div class="form-check d-flex align-items-center mb-0">
                                <input class="form-check-input flex-shrink-0 me-3" type="radio" name="expense_type" id="expenseHost" value="host_pays" {{ old('expense_type') == 'host_pays' ? 'checked' : '' }}>
                                <label class="form-check-label flex-grow-1 cursor-pointer w-100 m-0 py-1" for="expenseHost">
                                    <div class="fw-bold text-warning-custom"><i class="bi bi-gift me-1"></i> Host Pays</div>
        ...
        <!-- Form Footer Buttons -->
        <div class="pt-4 mt-2 d-flex justify-content-end align-items-center gap-3 border-top border-secondary border-opacity-10">
            <a href="{{ route('meetups.my') }}" class="btn btn-outline-light rounded-pill px-4 py-2">
                <span>Cancel</span>
            </a>
            <button type="submit" class="hero-btn-primary" style="min-width: auto; border: none; padding: 0.6rem 1.8rem;">
