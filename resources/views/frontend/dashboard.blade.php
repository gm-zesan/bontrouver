                ...
                <div class="d-flex align-items-center justify-content-between gap-3">
                    <div class="d-flex align-items-center gap-3">
                        @if(Auth::user()->avatar ?? false)
                            <img src="{{ Auth::user()->avatar }}" alt="{{ Auth::user()->name }}" class="rounded-circle object-fit-cover shadow-sm" style="width: 48px; height: 48px; border: 2px solid var(--color-primary, #49D17D);">
                        @else
                            <div class="rounded-circle shadow-sm d-flex align-items-center justify-content-center text-dark fw-bold" style="width: 48px; height: 48px; background: var(--color-primary, #49D17D);">
                                {{ substr(Auth::user()->name ?? 'U', 0, 1) }}
                            </div>
                        @endif
                        <div>
                            <h6 class="fw-bold mb-0 text-white">{{ Auth::user()->name ?? 'Marketplace User' }}</h6>
                            <span class="small text-secondary">Member since {{ Auth::user()->created_at ? Auth::user()->created_at->format('Y') : '2024' }}</span>
                        </div>
                    </div>
            ...
            <div class="col-12 col-lg-8 col-xl-9">
                ...
                <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3 mb-4">
                    <div>
                        <h1 class="h3 fw-bold text-white mb-1">
                            Welcome back, {{ explode(' ', Auth::user()->name ?? 'Friend')[0] }} 👋
                        </h1>
                        <p class="text-secondary mb-0">Here's what's happening with your marketplace activity.</p>
                    </div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="dark-surface-card p-3 h-100 stat-dark-hover">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="stat-dark-icon bg-success-subtle text-success rounded-3 p-1 d-flex align-items-center justify-content-center">
                                    <i class="bi bi-broadcast"></i>
                                </div>
                            </div>
                            <div class="fs-3 fw-bold text-white lh-1">{{ $stats['active_listings'] ?? 0 }}</div>
                            <a href="{{ route('listings.my') }}?status=active" class="small text-decoration-none text-secondary mt-2 d-inline-block hover-brand-green">
                    ...
                    <div class="col-6 col-md-3">
                        <div class="dark-surface-card p-3 h-100 stat-dark-hover">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="stat-dark-icon bg-primary-subtle text-primary rounded-3 p-1 d-flex align-items-center justify-content-center">
                                    <i class="bi bi-check2-circle"></i>
                                </div>
                            </div>
                            <div class="fs-3 fw-bold text-white lh-1">{{ $stats['sold_listings'] ?? 0 }}</div>
                            <a href="{{ route('listings.my') }}?status=sold" class="small text-decoration-none text-secondary mt-2 d-inline-block hover-brand-green">
                    ...
                    <div class="col-6 col-md-3">
                        <div class="dark-surface-card p-3 h-100 stat-dark-hover">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="stat-dark-icon bg-danger-subtle text-danger rounded-3 p-1 d-flex align-items-center justify-content-center">
                                    <i class="bi bi-heart-fill"></i>
                                </div>
                            </div>
                            <div class="fs-3 fw-bold text-white lh-1">{{ $stats['saved_favorites_count'] ?? 0 }}</div>
                            <a href="{{ url('/favorites') }}" class="small text-decoration-none text-secondary mt-2 d-inline-block hover-brand-green">
                    ...
                    <div class="col-6 col-md-3">
                        <div class="dark-surface-card p-3 h-100 stat-dark-hover">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="stat-dark-icon bg-info-subtle text-info rounded-3 p-1 d-flex align-items-center justify-content-center">
                                    <i class="bi bi-eye-fill"></i>
                                </div>
                            </div>
                            <div class="fs-3 fw-bold text-white lh-1">{{ number_format($stats['total_views'] ?? 0) }}</div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6 col-sm-3">
                            <a href="{{ url('/favorites') }}" class="quick-action-dark-box">
                                ...
                                <span class="text-secondary" style="font-size: 0.72rem;">{{ $stats['saved_favorites_count'] ?? 0 }} saved ads</span>
                            </a>
                        </div>
                        <div class="col-6 col-sm-3">
                            <a href="{{ url('/messages') }}" class="quick-action-dark-box">
                                ...
                                <span class="text-secondary" style="font-size: 0.72rem;">{{ $stats['unread_messages_count'] ?? 0 }} unread chat</span>
                            </a>
                        </div>
                        <div class="col-6 col-sm-3">
                        ...
                        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                            <div class="d-flex align-items-center gap-3">
                                <div class="profile-progress-circle position-relative flex-shrink-0">
                                    <div class="rounded-circle d-flex align-items-center justify-content-center fw-bold" style="width: 52px; height: 52px; background: rgba(73, 209, 125, 0.15); color: var(--color-primary, #49D17D); border: 2px solid var(--color-primary, #49D17D);">
                                        {{ $profileCompletion['percentage'] }}%
                                    </div>
                                </div>
                                <div>
                                    <h6 class="fw-bold text-white mb-1">Complete your profile</h6>
                                    <p class="text-secondary small mb-0">Add verified contact details to build higher trust with Canadian buyers and sellers.</p>
                                </div>
                            </div>
                            <div class="flex-shrink-0">
                                <a href="{{ route('profile.edit') }}" class="btn-theme-outline-primary px-3 py-2 small rounded-pill">
                                    Complete Profile
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-xl-7">
                        <div class="dark-surface-card p-3 p-md-4 h-100">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <a href="{{ url('/activity') }}" class="small text-decoration-none text-secondary hover-brand-green">View all</a>
                            </div>
                                ...
                                <div class="activity-feed-list d-flex flex-column gap-2">
                                    @foreach($activities as $act)
                                        <div class="activity-dark-item d-flex align-items-start gap-3 p-2 rounded-3">
                                            <div class="activity-icon-badge {{ $act['bg'] }} {{ $act['color'] }} rounded-circle p-2 d-flex align-items-center justify-content-center flex-shrink-0" style="width: 36px; height: 36px;">
                                                <i class="bi {{ $act['icon'] }} fs-6"></i>
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden">
                                                <div class="activity-title small fw-medium text-truncate">
                                                    <a href="{{ $act['link'] }}" class="text-decoration-none text-white hover-brand-green">
                                                        {{ $act['title'] }}
                                                    </a>
                                                </div>
                                                <span class="activity-time text-secondary" style="font-size: 0.75rem;">{{ $act['time'] }}</span>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="dark-surface-card p-3 p-md-4 h-100 d-flex flex-column justify-content-between">
                            <div>
                                ...
                                <div class="verification-list d-flex flex-column gap-2 mb-4">
                                    <div class="d-flex align-items-center justify-content-between p-2 rounded-3" style="background: #081D33; border: 1px solid var(--border-color, #18344D);">
                                        ...
                                        <span class="badge bg-success-subtle text-success px-2 py-1 small">Verified</span>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between p-2 rounded-3" style="background: #081D33; border: 1px solid var(--border-color, #18344D);">
                                        <span class="small text-white d-flex align-items-center gap-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between p-2 rounded-3" style="background: #081D33; border: 1px solid var(--border-color, #18344D);">
                                        ...
                                        <a href="{{ route('profile.edit') }}" class="small text-success text-decoration-none fw-semibold hover-brand-green">Verify Now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="border-top border-secondary border-opacity-25 pt-3">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="fw-bold small text-white"><i class="bi bi-bell-fill text-warning me-1"></i> Notifications</span>
                                    <a href="{{ url('/notifications') }}" class="small text-secondary text-decoration-none hover-brand-green">View all</a>
                                </div>
                                    ...
                                    @foreach(array_slice($recentNotifications, 0, 2) as $notif)
                                        <div class="small text-secondary d-flex align-items-start gap-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <span class="{{ !$notif['read'] ? 'fw-semibold text-white' : '' }}">{{ $notif['title'] }}</span>
                ...
                <div class="dark-surface-card p-3 p-md-4 mb-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <a href="{{ route('listings.my') }}" class="btn-theme-outline-primary px-3 py-1 small rounded-pill">
                                ...
                                <div class="seller-listing-dark-row">
                                    <div class="d-flex align-items-center gap-3 overflow-hidden">
                                        <div class="listing-thumb-box">
                                            <img src="{{ $listing['image'] }}" alt="{{ $listing['title'] }}" class="listing-thumb-img" onerror="this.src='https://images.unsplash.com/photo-1584438784894-089d6a62b8fa?auto=format&fit=crop&w=200&q=80'">
                                        </div>
                                        <div class="overflow-hidden">
                                            <h6 class="fw-bold text-white mb-0 text-truncate">
                                                <a href="{{ url('/listing/' . $listing['id']) }}" class="text-decoration-none text-white hover-brand-green">
                                                    {{ $listing['title'] }}
                                                </a>
                                            </h6>
                                            <div class="small text-secondary d-flex align-items-center gap-2 flex-wrap mt-1">
                                                ...
                                                <span>•</span>
                                                <span><i class="bi bi-eye text-secondary me-1"></i>{{ $listing['views'] }} views</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center gap-2 flex-shrink-0">
                                        <span class="badge bg-success-subtle text-success border border-success-subtle px-2 py-1 small d-none d-sm-inline-block">
                                            Active
                                        </span>
                                        <a href="{{ url('/post-ad?edit=' . $listing['id']) }}" class="btn btn-sm btn-dark border border-secondary border-opacity-25 py-1 px-2 text-white" title="Edit Listing">
                    ...
                    @else
                        ...
                        <div class="text-center py-4 rounded-4" style="background: #081D33; border: 1px dashed var(--border-color, #18344D);">
                            ...
                            <p class="text-secondary small mb-3">Have something to sell or trade? Create your first listing and reach verified buyers.</p>
                ...
                <div class="dark-surface-card p-3 p-md-4 mb-4">
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="saved-card-dark h-100">
                                        <div class="position-relative" style="height: 140px;">
                                            <img src="{{ $saved['image'] }}" alt="{{ $saved['title'] }}" class="w-100 h-100 object-fit-cover">
                                            <span class="badge bg-dark bg-opacity-75 text-white position-absolute bottom-0 start-0 m-2 px-2 py-1 small">
                                                {{ $saved['location'] }}
                                            </span>
                                            <button type="button" class="btn btn-sm btn-dark rounded-circle position-absolute top-0 end-0 m-2 p-1 text-danger shadow border border-secondary border-opacity-25" title="Remove from favorites">
                                                <i class="bi bi-heart-fill"></i>
                                            </button>
                                        </div>
                                        <div class="p-3">
                                            ...
                                            <h6 class="small fw-semibold text-white text-truncate mb-2">
                                                <a href="{{ $saved['url'] }}" class="text-decoration-none text-white hover-brand-green">
                                                    {{ $saved['title'] }}
                                                </a>
                                            </h6>
                    ...
                    @else
                        ...
                        <div class="text-center py-4 rounded-4" style="background: #081D33; border: 1px dashed var(--border-color, #18344D);">
                            ...
                            <p class="text-secondary small mb-3">Browse items in your area and tap the heart icon to save listings for later.</p>
                ...
                <div class="dark-surface-card p-3 p-md-4">
                                ...
                                <a href="{{ url('/messages') }}" class="text-decoration-none message-dark-row">
                                    <div class="d-flex align-items-center gap-3 overflow-hidden">
                                        <div class="position-relative flex-shrink-0">
                                            <img src="{{ $msg['partner_avatar'] }}" alt="{{ $msg['partner_name'] }}" class="rounded-circle object-fit-cover shadow-sm" style="width: 44px; height: 44px;">
                                            @if($msg['unread'])
                                        ...
                                        <div class="overflow-hidden">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <span class="badge bg-dark-subtle text-secondary border border-secondary border-opacity-25 px-1" style="font-size: 0.68rem;">{{ $msg['listing_title'] }}</span>
                                            </div>
                                            <p class="mb-0 text-secondary small text-truncate {{ $msg['unread'] ? 'fw-semibold text-white' : '' }}">
                                                "{{ $msg['last_message'] }}"
                                            </p>
                                        </div>
                                    </div>
                                    <div class="text-end flex-shrink-0">
                                        ...
                                        @if($msg['unread'])
                                            <span class="badge bg-success text-dark rounded-pill px-2 py-0 ms-2" style="font-size: 0.65rem;">NEW</span>
                                        @endif
                                    </div>
                                </a>
                            @endforeach
                    ...
                    @else
                        <div class="text-center py-4 rounded-4" style="background: #081D33; border: 1px dashed var(--border-color, #18344D);">
                            ...
                            <p class="text-secondary small mb-0">When buyers or sellers contact you, your conversations will appear here.</p>
                        </div>
                    @endif
                </div>
